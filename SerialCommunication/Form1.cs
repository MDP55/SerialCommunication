    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonConnect_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // Een verbinding --> Gebruiker wilt verbreken 
                ...
                {
                    // Geen verbinding --> Gebruiker verbinding maken
        ...
        private void checkBoxDigital2_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (serialPortArduino.IsOpen)
                {
                    string commando; // Voor d2 high of low
        ...
        private void checkBoxDigital3_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (serialPortArduino.IsOpen)
                {
                    string commando; // Voor d3 high of low
        ...
        private void checkBoxDigital4_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (serialPortArduino.IsOpen)
                {
                    string commando; // Voor d4 high of low
        ...
        private void trackBarPWM9_Scroll(object sender, EventArgs e)
        {
            try
            {
                if (serialPortArduino.IsOpen)
                {
                    string commando = string.Format("set pwm9 {0}", trackBarPWM9.Value); // set pwm9 van 0 --> 225
                    serialPortArduino.WriteLine(commando);
                }
            }
            catch (Exception exception)
        ...
        private void trackBarPWM10_Scroll(object sender, EventArgs e)
        {
            try
            {
                if (serialPortArduino.IsOpen)
                {
                    string commando = string.Format("set pwm10 {0}", trackBarPWM10.Value); // set pwm10 van 0 --> 225
                    serialPortArduino.WriteLine(commando);
                }
            }
            catch (Exception exception)
        ...
        private void trackBarPWM11_Scroll(object sender, EventArgs e)
        {
            try
            {
                if (serialPortArduino.IsOpen)
                {
                    string commando = string.Format("set pwm11 {0}", trackBarPWM11.Value); // set pwm11 van 0 --> 225
                    serialPortArduino.WriteLine(commando);
                }
            }
            catch (Exception exception)
        ...
        private void timerOefening4_Tick(object sender, EventArgs e)
        {
            try
            {
                if (serialPortArduino.IsOpen)
                {
                    ...
                    antwoord = antwoord.TrimEnd();
                    antwoord= antwoord.Substring(4);
                    int waarde = Int32.Parse(antwoord);
                    labelAnalog0.Text = string.Format("{0}", antwoord);
